...
<div class="container theme-showcase" role="main">
	...
	<div class="page-header">
		<h1>Dataset Contratti</h1>
	</div>
	<a href="#list-contrattiDataSet" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
	...
	<div id="list-contrattiDataSet" class="content scaffold-list" role="main">
		<h1><g:message code="default.list.label" args="[entityName]" /></h1>
		<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
		</g:if>
		<f:table collection="${contrattiDataSetList}" />

		<div class="pagination">
			<g:paginate total="${contrattiDataSetCount ?: 0}" />
		</div>
	</div>
		...
		<div class="col-md-6">
			<table class="table table-striped">
				...
				<tr>
					...
					<td>Otto</td>
					<td>@mdo</td>
					<td><button type="button" class="btn btn-sm btn-default">Default</button> </td>
					<td><button type="button" class="btn btn-sm btn-default">Default</button> </td>
					<td><button type="button" class="btn btn-sm btn-default">Default</button> </td>
				</tr>
				<tr>
